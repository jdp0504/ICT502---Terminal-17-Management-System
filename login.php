...
<head>
    ...
    <style>
        ...
        .error { color: #dc2626; background: #fee2e2; padding: 10px; border-radius: 4px; margin-bottom: 15px; font-size: 14px; text-align: center; }
...
<body>
    ...
    <div class="login-card">
        <h2>Terminal 17 Portal Login</h2>
        ...
        <form method="POST" action="login.php">
            ...
            <input type="email" id="email" name="email" placeholder="e.g. jeremy@uitm.edu.my" required>
        ...
        <div class="demo-hint">
            ...
            Email: <code>admin@uitm.edu.my</code> / Password: <code>password123</code><br>
            <strong>Customer Login:</strong><br>
            Email: <code>jeremy@uitm.edu.my</code> / Password: <code>password123</code><br>
            <em>(register a new account at the link below for customer access)</em>
        </div>
